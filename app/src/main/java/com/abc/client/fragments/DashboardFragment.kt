package com.abc.client.fragments
...
import com.abc.client.activity.SetupActionBar
import com.abc.client.data.models.Client
import com.abc.client.data.viewmodel.ClientDetailsViewModel
import com.abc.client.databinding.FragmentDashboardBinding
...
class DashboardFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        mClientDetailsViewModel.fetchClientData().observe(viewLifecycleOwner, Observer {
            client = it
        })
